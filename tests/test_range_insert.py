...
class testRangeInsert(unittest.TestCase):
    ...
    def test_front_insert(self):
        ...
        self.assertEqual(len(test_player.hand.ranges), test_player.hand.num_cards + 1, "Error - Number of ranges invalid")
        ...
        self.assertEqual(test_player.hand.ranges[0], (0,0), "Error - Range not 0,0")
        self.assertEqual(test_player.hand.ranges[1][0], 0, "Error - First element of next tuple not changed")
    ...
    def test_end_insert(self):
        ...
        self.assertEqual(p.hand.ranges, [(0,15), (15,38), (38,74), (74,90), (90, 100), (100, 100)], "End insert case 3")
    ...
    def test_duplicate_inserts(self):
        ...
        self.assertEqual(p.hand.ranges, [(0,20), (20,30), (30,30), (30,81), (81, 100)], "Duplicate insert case 2")

        p.hand.gain_card(Card("Bitten by monkey", 30))
        self.assertEqual(p.hand.ranges, [(0,20), (20,30), (30,30), (30,30), (30,81), (81, 100)], "Duplicate insert case 2")

        p.hand.gain_card(Card("Devoured by giant spider", 81))
        self.assertEqual(p.hand.ranges, [(0,20), (20,30), (30,30), (30,30), (30,81), (81,81), (81, 100)], "Duplicate insert case 3")

        p.hand.gain_card(Card("Devoured by giant spider", 81))
        self.assertEqual(p.hand.ranges, [(0,20), (20,30), (30,30), (30,30), (30,81), (81, 81), (81, 81), (81, 100)], "Duplicate insert case 4")

        p.hand.gain_card(Card("Devoured by giant spider", 81))
        self.assertEqual(p.hand.ranges, [(0,20), (20,30), (30,30), (30,30), (30,81), (81, 81), (81, 81), (81, 81), (81, 100)], "Duplicate insert case 5")

        p.hand.gain_card(Card("Devoured by giant spider", 81))
        self.assertEqual(p.hand.ranges, [(0,20), (20,30), (30,30), (30,30), (30,81), (81, 81), (81, 81), (81, 81), (81, 81), (81, 100)], "Duplicate insert case 6")
